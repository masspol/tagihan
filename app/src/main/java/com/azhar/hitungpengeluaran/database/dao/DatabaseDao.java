...
public interface DatabaseDao {
    ...
    @Query("UPDATE tbl_keuangan SET pelanggan = :pelanggan, keterangan = :keterangan,  tanggal = :tgl, jml_uang = :harga WHERE uid = :uid and tipe = 'pengeluaran'")
    void updateDataPengeluaran(String pelanggan, String keterangan, String tgl, int harga, int uid);
    ...
    @Query("UPDATE tbl_keuangan SET pelanggan = :pelanggan, keterangan = :keterangan , tanggal = :tgl, jml_uang = :harga WHERE uid = :uid and tipe = 'pemasukan'")
    void updateDataPemasukan(String pelanggan, String keterangan, String tgl, int harga, int uid);
}
