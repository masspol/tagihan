...
public class PengeluaranAdapter extends RecyclerView.Adapter<PengeluaranAdapter.ViewHolder> {
    ...
    public PengeluaranAdapter(Context context, List<ModelDatabase> list,
                              PengeluaranAdapterCallback adapterCallback) {
    ...
    public void addData(List<ModelDatabase> pengeluaran) {
        this.list = pengeluaran;
        notifyDataSetChanged();
    }

    public class ViewHolder extends RecyclerView.ViewHolder {

        public TextView tvPrice, tvPlg, tvNote, tvDate;
        ...
        ViewHolder(View itemView) {
            ...
            tvPlg = itemView.findViewById(R.id.tvPlg);
