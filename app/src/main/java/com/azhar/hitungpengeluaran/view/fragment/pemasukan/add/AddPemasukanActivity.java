...
public class AddPemasukanActivity extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        if (mIsEdit) {
            ...
            if (pemasukan != null) {
                strId = pemasukan.uid;
                String pelanggan = pemasukan.pelanggan;
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (strKeterangan.isEmpty() || strTanggal.isEmpty() || strJmlUang.isEmpty()) {
                    ...
                    if (mIsEdit) {
                        addPemasukanViewModel.updatePemasukan(strId, strPelanggan, strKeterangan, strTanggal,
                                Integer.parseInt(strJmlUang));
                    } else {
                        addPemasukanViewModel.addPemasukan(strTipe, strPelanggan, strKeterangan, strTanggal,
                                Integer.parseInt(strJmlUang));
                    }
                    finish();
                }
